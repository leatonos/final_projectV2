...
extension NotesViewController: UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        globalVariables.chosenNotetitle = diaryNotes[indexPath.row].title
        globalVariables.chosenNoteText = diaryNotes[indexPath.row].text
        globalVariables.chosenNoteDate = diaryNotes[indexPath.row].date
